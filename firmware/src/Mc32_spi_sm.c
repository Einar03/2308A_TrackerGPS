...
//    PLIB_SPI_PinEnable(SPI_USED, SPI_PIN_DATA_OUT);
    ...
    PLIB_SPI_BaudRateSet(SPI_USED, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_1), 400000);
    ...
    PLIB_SPI_ClockPolaritySelect(SPI_USED, SPI_CLOCK_POLARITY_IDLE_HIGH);
